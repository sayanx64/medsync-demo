...
$apiSites = [
    'localhost'                     => 'http://34.93.81.71/medsync-demo', // Replace with your local OpenEMR URL
    'dev-xampp-domain'     => 'http://34.93.81.71/medsync-demo', // Replace with your dev domain
    'remote-ubuntu-php-8.3' => 'https://six.openemr.io/a/medsync-demo', // Remotes need work. Could be proxie issues. May need to set override in Config connector for proxy!
    'remote-alpine-php-8.2'   => 'https://two.openemr.io/a/medsync-demo',
    'remote-alpine-php-8.3'   => 'https://one.openemr.io/a/medsync-demo',
    'remote-alpine-php-8.4'   => 'https://seven.openemr.io/a/medsync-demo',
